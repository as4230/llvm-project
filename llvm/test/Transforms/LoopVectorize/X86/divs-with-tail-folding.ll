...
; CHECK-NEXT:    [[TMP6:%.*]] = udiv <4 x i64> [[VEC_IND]], [[BROADCAST_SPLAT2]]
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP6]], i64 0
; CHECK-NEXT:    [[TMP8:%.*]] = urem i64 [[INDEX]], [[MUL_2_I]]
; CHECK-NEXT:    [[TMP9:%.*]] = udiv i64 [[TMP8]], [[MUL_1_I]]
; CHECK-NEXT:    [[TMP10:%.*]] = urem i64 [[TMP8]], [[MUL_1_I]]
; CHECK-NEXT:    [[TMP11:%.*]] = udiv i64 [[TMP10]], [[X]]
; CHECK-NEXT:    [[TMP12:%.*]] = urem i64 [[TMP10]], [[X]]
; CHECK-NEXT:    [[TMP13:%.*]] = mul i64 [[X]], [[TMP7]]
; CHECK-NEXT:    [[TMP14:%.*]] = add i64 [[TMP13]], [[TMP9]]
; CHECK-NEXT:    [[TMP15:%.*]] = mul i64 [[TMP14]], [[X]]
; CHECK-NEXT:    [[TMP16:%.*]] = add i64 [[TMP15]], [[TMP11]]
; CHECK-NEXT:    [[TMP17:%.*]] = mul i64 [[TMP16]], [[X]]
; CHECK-NEXT:    [[TMP18:%.*]] = add i64 [[TMP17]], [[TMP12]]
; CHECK-NEXT:    [[TMP19:%.*]] = shl i64 [[TMP18]], 32
; CHECK-NEXT:    [[TMP20:%.*]] = ashr i64 [[TMP19]], 32
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr i64, ptr [[DST]], i64 [[TMP20]]
; CHECK-NEXT:    call void @llvm.masked.store.v4i64.p0(<4 x i64> [[TMP6]], ptr align 4 [[TMP21]], <4 x i1> [[TMP5]])
; CHECK-NEXT:    [[INDEX_NEXT]] = add i64 [[INDEX]], 4
; CHECK-NEXT:    [[VEC_IND_NEXT]] = add <4 x i64> [[VEC_IND]], splat (i64 4)
