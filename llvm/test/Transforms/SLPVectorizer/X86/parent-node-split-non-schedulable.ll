...
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <4 x i32> <i32 poison, i32 1, i32 0, i32 poison>, i32 [[TMP0]], i64 3
; CHECK-NEXT:    [[TMP3:%.*]] = insertelement <4 x i32> poison, i32 [[TMP0]], i64 2
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <4 x i32> <i32 1, i32 poison, i32 1, i32 1>, i32 [[TMP0]], i64 1
; CHECK-NEXT:    br label %[[IF_END:.*]]
; CHECK:       [[IF_END]]:
; CHECK-NEXT:    [[B_0_PH:%.*]] = phi i32 [ 0, %[[ENTRY]] ], [ [[TMP32:%.*]], %[[WHILE_COND_PREHEADER:.*]] ]
; CHECK-NEXT:    [[TMP7:%.*]] = phi <2 x i32> [ zeroinitializer, %[[ENTRY]] ], [ [[TMP33:%.*]], %[[WHILE_COND_PREHEADER]] ]
; CHECK-NEXT:    [[TMP9:%.*]] = insertelement <4 x i32> [[TMP2]], i32 [[B_0_PH]], i64 0
; CHECK-NEXT:    br i1 [[TOBOOL4_NOT]], label %[[R:.*]], label %[[IF_END9:.*]]
; CHECK:       [[IF_END9]]:
; CHECK-NEXT:    [[CONV11:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <4 x i32> <i32 poison, i32 0, i32 1, i32 0>, i32 [[CONV11]], i64 0
; CHECK-NEXT:    br label %[[R]]
; CHECK:       [[R]]:
; CHECK-NEXT:    [[TMP8:%.*]] = phi <4 x i32> [ [[TMP13]], %[[IF_END9]] ], [ [[TMP9]], %[[IF_END]] ]
...
; CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <4 x i32> [[TMP3]], <4 x i32> [[TMP6]], <4 x i32> <i32 4, i32 poison, i32 2, i32 5>
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <4 x i32> [[TMP11]], i32 [[TMP10]], i64 1
; CHECK-NEXT:    [[TMP14:%.*]] = and <4 x i32> [[TMP12]], <i32 1, i32 -1, i32 1, i32 1>
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <4 x i32> <i32 -1, i32 poison, i32 -1, i32 -1>, <4 x i32> [[TMP6]], <4 x i32> <i32 0, i32 4, i32 2, i32 3>
...
; CHECK-NEXT:    [[TMP21:%.*]] = insertelement <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 poison>, i32 [[B_0_PH]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = insertelement <8 x i32> [[TMP21]], i32 [[TMP0]], i64 7
; CHECK-NEXT:    br label %[[AH:.*]]
; CHECK:       [[AH]]:
; CHECK-NEXT:    [[TMP23:%.*]] = phi <8 x i32> [ [[TMP22]], %[[AH]] ], [ [[TMP20]], %[[IF_END14]] ]
; CHECK-NEXT:    [[TMP25:%.*]] = extractelement <8 x i32> [[TMP23]], i64 5
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <8 x i32> [[TMP23]], i64 7
; CHECK-NEXT:    [[ADD:%.*]] = add i32 [[TMP25]], [[TMP26]]
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <8 x i32> [[TMP23]], i64 4
; CHECK-NEXT:    [[TMP29:%.*]] = or i32 [[ADD]], [[TMP28]]
; CHECK-NEXT:    [[TMP30:%.*]] = extractelement <8 x i32> [[TMP23]], i64 6
...
; CHECK-NEXT:    [[TMP31:%.*]] = extractelement <8 x i32> [[TMP23]], i64 1
; CHECK-NEXT:    [[CALL69:%.*]] = tail call i32 @s(i32 [[TMP31]])
; CHECK-NEXT:    [[TMP32]] = extractelement <8 x i32> [[TMP23]], i64 0
; CHECK-NEXT:    [[TMP33]] = shufflevector <8 x i32> [[TMP23]], <8 x i32> poison, <2 x i32> <i32 2, i32 3>
; CHECK-NEXT:    br label %[[IF_END]]
;
entry:
  br label %if.end
